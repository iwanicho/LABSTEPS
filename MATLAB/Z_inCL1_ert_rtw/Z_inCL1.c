 ...
 *    '<S5>/VL2duty'
 */
void Z_inCL1_VL2duty(real_T rtu_VLref, real_T rtu_Vin_fb, real_T rtu_Vout_fb,
                     B_VL2duty_Z_inCL1_T *localB)
{
  real_T x_idx_1;

  /* MATLAB Function 'ADC-PWM Subsystem/control/VL2duty': '<S7>:1' */
  /* '<S7>:1:4' */
...
void Z_inCL1_initialize(void)
{
  ...
  /* block I/O */
  {
    ...
    Z_inCL1_B.sf_VL2duty_o.D = 0.0;
    Z_inCL1_B.sf_VL2duty_f.D = 0.0;
    Z_inCL1_B.sf_VL2duty.D = 0.0;
  }

  /* states (dwork) */
  Z_inCL1_DW.discreteintegrator_states = 0.0;
  Z_inCL1_DW.discreteintegrator_states_m = 0.0;
  Z_inCL1_DW.discreteintegrator_states_c = 0.0;
  Z_inCL1_DW.Memory3_PreviousInput = 0.0;
  Z_inCL1_DW.Memory3_PreviousInput_e = 0.0;
  Z_inCL1_DW.Memory3_PreviousInput_h = 0.0;
  ...
  /* Start for S-Function (c280xpwm): '<S1>/ePWM4' */
  ...
  Z_inCL1_DW.Memory3_PreviousInput_e = Z_inCL1_P.Memory3_InitialCondition_e;

  /* InitializeConditions for DiscreteTransferFcn: '<S3>/discrete integrator' */
  Z_inCL1_DW.discreteintegrator_states_m =
    Z_inCL1_P.discreteintegrator_InitialSta_o;

  /* InitializeConditions for Memory: '<S5>/Memory3' */
  Z_inCL1_DW.Memory3_PreviousInput_h = Z_inCL1_P.Memory3_InitialCondition_i;

  /* InitializeConditions for DiscreteTransferFcn: '<S5>/discrete integrator' */
  Z_inCL1_DW.discreteintegrator_states_c =
    Z_inCL1_P.discreteintegrator_InitialSta_g;
    ...
    if (1 == runModel) {
      {
        ...
        /* Output and update for function-call system: '<Root>/ADC-PWM Subsystem' */
        {
          ...
          real_T discreteintegrator_tmp_j;
          real_T rtb_Gain13;
           ...
           *  Gain: '<S5>/Gain3'
           */
          rtb_Gain5_tmp = Z_inCL1_P.VLlim * Z_inCL1_P.Constant2_Value;

          /* Gain: '<S1>/Gain15' incorporates:
           *  Constant: '<S1>/Constant'
           */
          Z_inCL1_B.Gain4 = Z_inCL1_P.Gain15_Gain * Z_inCL1_P.Constant_Value;
           ...
           *  Gain: '<S1>/Gain10'
           */
          Z_inCL1_B.Gain3 = ((1.0 / Z_inCL1_P.ADC_mapping *
                              Z_inCL1_B.analogdial_o5 * 2.0 * 10.0 - 10.0) * 2.0
                             - 0.4) * Z_inCL1_P.Gain7_Gain;
           ...
           *  Sum: '<S4>/Sum3'
           */
          discreteintegrator_tmp = (((Z_inCL1_B.Gain4 - Z_inCL1_B.Gain3) -
           ...
           *  Gain: '<S4>/Gain1'
           */
          Z_inCL1_B.Gain = (Z_inCL1_P.znum_Integrator[0] *
                            discreteintegrator_tmp + Z_inCL1_P.znum_Integrator
                            [1L] * Z_inCL1_DW.discreteintegrator_states) -
            Z_inCL1_P.kp_i * Z_inCL1_B.Gain3;

          /* Gain: '<S1>/Gain12' incorporates:
           *  Gain: '<S1>/Gain9'
           */
          Z_inCL1_B.Vfb = 1.0 / Z_inCL1_P.ADC_mapping * Z_inCL1_B.analogdial_o4 *
            Z_inCL1_P.VfbMax;
           ...
           */
          if (Z_inCL1_B.Gain > rtb_Gain5_tmp) {
            Z_inCL1_B.Switch2 = rtb_Gain5_tmp;
          } else {
            /* Sum: '<S4>/Sum4' incorporates:
             *  Constant: '<S1>/Constant2'
             */
            Z_inCL1_B.Gain5 = Z_inCL1_P.Constant2_Value - Z_inCL1_B.Vfb;

            /* Switch: '<S8>/Switch' incorporates:
             *  RelationalOperator: '<S8>/UpperRelop'
             */
            if (Z_inCL1_B.Gain < Z_inCL1_B.Gain5) {
              Z_inCL1_B.Switch2 = Z_inCL1_B.Gain5;
            } else {
              Z_inCL1_B.Switch2 = Z_inCL1_B.Gain;
            }
          ...
          /* MATLAB Function: '<S4>/VL2duty' incorporates:
           *  Constant: '<S1>/Constant2'
           */
          Z_inCL1_VL2duty(Z_inCL1_B.Switch2, Z_inCL1_P.Constant2_Value,
                          Z_inCL1_B.Vfb, &Z_inCL1_B.sf_VL2duty_f);

          /* DataTypeConversion: '<S1>/Cast To Single1' incorporates:
           *  Gain: '<S1>/Gain3'
           */
          rtb_Gain13 = floor(Z_inCL1_P.TBPRD * Z_inCL1_B.sf_VL2duty_f.D);
          if (rtIsNaN(rtb_Gain13) || rtIsInf(rtb_Gain13)) {
            rtb_Gain13 = 0.0;
          } else {
            rtb_Gain13 = fmod(rtb_Gain13, 65536.0);
          }
          ...
          {
            EPwm2Regs.CMPA.half.CMPA = (uint16_T)((rtb_Gain13 < 0.0 ? (uint16_T)
              -(int16_T)(uint16_T)-rtb_Gain13 : (uint16_T)rtb_Gain13));
          }
           ...
           *  Gain: '<S1>/Gain8'
           */
          Z_inCL1_B.Gain5 = (1.0 / Z_inCL1_P.ADC_mapping *
                             Z_inCL1_B.analogdial_o3 * 2.0 * 10.0 - 10.0) *
            Z_inCL1_P.Gain2_Gain;
           ...
           *  Sum: '<S3>/Sum3'
           */
          discreteintegrator_tmp_j = (((Z_inCL1_B.Gain4 - Z_inCL1_B.Gain5) -
            Z_inCL1_DW.Memory3_PreviousInput_e) * Z_inCL1_P.ki_i -
            Z_inCL1_P.zden_Integrator[1L] *
            Z_inCL1_DW.discreteintegrator_states_m) / Z_inCL1_P.zden_Integrator
            [0];
           ...
           *  Gain: '<S3>/Gain1'
           */
          rtb_Gain_h = (Z_inCL1_P.znum_Integrator[0] * discreteintegrator_tmp_j
                        + Z_inCL1_P.znum_Integrator[1L] *
                        Z_inCL1_DW.discreteintegrator_states_m) - Z_inCL1_P.kp_i
            * Z_inCL1_B.Gain5;

          /* Switch: '<S6>/Switch2' incorporates:
           *  RelationalOperator: '<S6>/LowerRelop1'
           */
          if (rtb_Gain_h > rtb_Gain5_tmp) {
            rtb_Switch2_p = rtb_Gain5_tmp;
          } else {
            /* Sum: '<S3>/Sum4' incorporates:
             *  Constant: '<S1>/Constant2'
             */
            Z_inCL1_B.Gain3 = Z_inCL1_P.Constant2_Value - Z_inCL1_B.Vfb;

            /* Switch: '<S6>/Switch' incorporates:
             *  RelationalOperator: '<S6>/UpperRelop'
             */
            if (rtb_Gain_h < Z_inCL1_B.Gain3) {
              rtb_Switch2_p = Z_inCL1_B.Gain3;
            } else {
              rtb_Switch2_p = rtb_Gain_h;
            }
           ...
           *  Constant: '<S1>/Constant2'
           */
          Z_inCL1_VL2duty(rtb_Switch2_p, Z_inCL1_P.Constant2_Value,
                          Z_inCL1_B.Vfb, &Z_inCL1_B.sf_VL2duty);

          /* DataTypeConversion: '<S1>/Cast To Single2' incorporates:
           *  Gain: '<S1>/Gain1'
           */
          rtb_Gain13 = floor(Z_inCL1_P.TBPRD * Z_inCL1_B.sf_VL2duty.D);
          if (rtIsNaN(rtb_Gain13) || rtIsInf(rtb_Gain13)) {
            rtb_Gain13 = 0.0;
          } else {
            rtb_Gain13 = fmod(rtb_Gain13, 65536.0);
          ...
          {
            EPwm3Regs.CMPA.half.CMPA = (uint16_T)((rtb_Gain13 < 0.0 ? (uint16_T)
              -(int16_T)(uint16_T)-rtb_Gain13 : (uint16_T)rtb_Gain13));
          }

          /* Gain: '<S5>/Gain3' */
          Z_inCL1_B.Gain3 = rtb_Gain5_tmp;
           ...
           *  Gain: '<S1>/Gain11'
           */
          rtb_Gain13 = ((1.0 / Z_inCL1_P.ADC_mapping * Z_inCL1_B.analogdial_o6 *
                         2.0 * 10.0 - 10.0) - 0.29) * Z_inCL1_P.Gain6_Gain;
           ...
           *  Sum: '<S5>/Sum3'
           */
          discreteintegrator_tmp_i = (((Z_inCL1_B.Gain4 - rtb_Gain13) -
            Z_inCL1_DW.Memory3_PreviousInput_h) * Z_inCL1_P.ki_i -
            Z_inCL1_P.zden_Integrator[1L] *
            Z_inCL1_DW.discreteintegrator_states_c) / Z_inCL1_P.zden_Integrator
            [0];
           ...
           *  Gain: '<S5>/Gain1'
           */
          Z_inCL1_B.discreteintegrator = (Z_inCL1_P.znum_Integrator[0] *
            discreteintegrator_tmp_i + Z_inCL1_P.znum_Integrator[1L] *
            Z_inCL1_DW.discreteintegrator_states_c) - Z_inCL1_P.kp_i *
            rtb_Gain13;

          /* Switch: '<S10>/Switch2' incorporates:
           *  RelationalOperator: '<S10>/LowerRelop1'
           */
          if (!(Z_inCL1_B.discreteintegrator > rtb_Gain5_tmp)) {
             ...
             */
            if (!(Z_inCL1_B.discreteintegrator < Z_inCL1_B.Gain3)) {
              Z_inCL1_B.Gain3 = Z_inCL1_B.discreteintegrator;
            }
           ...
           *  Constant: '<S1>/Constant2'
           */
          Z_inCL1_VL2duty(Z_inCL1_B.Gain3, Z_inCL1_P.Constant2_Value,
                          Z_inCL1_B.Vfb, &Z_inCL1_B.sf_VL2duty_o);

          /* DataTypeConversion: '<S1>/Cast To Single3' incorporates:
           *  Gain: '<S1>/Gain14'
           */
          rtb_Gain13 = floor(Z_inCL1_P.TBPRD * Z_inCL1_B.sf_VL2duty_o.D);
          if (rtIsNaN(rtb_Gain13) || rtIsInf(rtb_Gain13)) {
            rtb_Gain13 = 0.0;
          } else {
            rtb_Gain13 = fmod(rtb_Gain13, 65536.0);
          ...
          /* S-Function (c280xpwm): '<S1>/ePWM4' incorporates:
           *  DataTypeConversion: '<S1>/Cast To Single3'
           */

          /*-- Update CMPA value for ePWM6 --*/
          {
            EPwm6Regs.CMPA.half.CMPA = (uint16_T)((rtb_Gain13 < 0.0 ? (uint16_T)
              -(int16_T)(uint16_T)-rtb_Gain13 : (uint16_T)rtb_Gain13));
          }
           ...
           *  Gain: '<S1>/Gain5'
           */
          rtb_Gain13 = floor(Z_inCL1_P.Gain5_Gain * Z_inCL1_B.Gain5);
          if (rtIsNaN(rtb_Gain13) || rtIsInf(rtb_Gain13)) {
            rtb_Gain13 = 0.0;
          } else {
            rtb_Gain13 = fmod(rtb_Gain13, 65536.0);
          ...
          {
            EPwm4Regs.CMPA.half.CMPA = (uint16_T)((rtb_Gain13 < 0.0 ? (uint16_T)
              -(int16_T)(uint16_T)-rtb_Gain13 : (uint16_T)rtb_Gain13));
          }
           ...
           *  Gain: '<S1>/Gain13'
           */
          rtb_Gain13 = floor(Z_inCL1_P.Gain13_Gain * Z_inCL1_B.Vfb);
          if (rtIsNaN(rtb_Gain13) || rtIsInf(rtb_Gain13)) {
            rtb_Gain13 = 0.0;
          } else {
            rtb_Gain13 = fmod(rtb_Gain13, 65536.0);
          ...
          {
            EPwm5Regs.CMPA.half.CMPA = (uint16_T)((rtb_Gain13 < 0.0 ? (uint16_T)
              -(int16_T)(uint16_T)-rtb_Gain13 : (uint16_T)rtb_Gain13));
          }
           ...
           *  Gain: '<S1>/Gain4'
           */
          rtb_Gain13 = floor(Z_inCL1_P.Gain4_Gain * Z_inCL1_B.Gain4);
          if (rtIsNaN(rtb_Gain13) || rtIsInf(rtb_Gain13)) {
            rtb_Gain13 = 0.0;
          } else {
            rtb_Gain13 = fmod(rtb_Gain13, 65536.0);
          ...
          {
            EPwm1Regs.CMPA.half.CMPA = (uint16_T)((rtb_Gain13 < 0.0 ? (uint16_T)
              -(int16_T)(uint16_T)-rtb_Gain13 : (uint16_T)rtb_Gain13));
          }
           ...
           *  Sum: '<S4>/Sum2'
           */
          Z_inCL1_DW.Memory3_PreviousInput = (Z_inCL1_B.Gain - Z_inCL1_B.Switch2)
            * Z_inCL1_P.kaw_i;
           ...
           *  Sum: '<S3>/Sum2'
           */
          Z_inCL1_DW.Memory3_PreviousInput_e = (rtb_Gain_h - rtb_Switch2_p) *
            Z_inCL1_P.kaw_i;

          /* Update for DiscreteTransferFcn: '<S3>/discrete integrator' */
          Z_inCL1_DW.discreteintegrator_states_m = discreteintegrator_tmp_j;

          /* Update for Memory: '<S5>/Memory3' incorporates:
           *  Gain: '<S5>/Gain2'
           *  Sum: '<S5>/Sum2'
           */
          Z_inCL1_DW.Memory3_PreviousInput_h = (Z_inCL1_B.discreteintegrator -
            Z_inCL1_B.Gain3) * Z_inCL1_P.kaw_i;

          /* Update for DiscreteTransferFcn: '<S5>/discrete integrator' */
          Z_inCL1_DW.discreteintegrator_states_c = discreteintegrator_tmp_i;
        }
