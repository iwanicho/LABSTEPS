...
void Z_OL3_initialize(void)
{
  ...
  /* block I/O */
  {
    Z_OL3_B.analogdial_o1 = 0.0;
    Z_OL3_B.analogdial_o2 = 0.0;
    Z_OL3_B.analogdial_o3 = 0.0;
    Z_OL3_B.analogdial_o4 = 0.0;
    Z_OL3_B.analogdial_o5 = 0.0;
    Z_OL3_B.analogdial_o6 = 0.0;
  }
  ...
  /* Start for S-Function (c280xpwm): '<S1>/pass to ePWM1' */
  ...
  /* Start for S-Function (c280xpwm): '<S1>/pass to ePWM2' */
    ...
    if (1 == runModel) {
      {
        ...
        /* Output and update for function-call system: '<Root>/ADC-PWM Subsystem' */
        {
           ...
           *  Gain: '<S1>/Gain1'
           */
          tmp = floor(Z_OL3_P.TBPRD * Z_OL3_P.Constant_Value);
          ...
          {
            Z_OL3_B.analogdial_o1 = (AdcRegs.ADCRESULT0) >> 4;
            Z_OL3_B.analogdial_o2 = (AdcRegs.ADCRESULT1) >> 4;
            Z_OL3_B.analogdial_o3 = (AdcRegs.ADCRESULT2) >> 4;
            Z_OL3_B.analogdial_o4 = (AdcRegs.ADCRESULT3) >> 4;
            Z_OL3_B.analogdial_o5 = (AdcRegs.ADCRESULT4) >> 4;
            Z_OL3_B.analogdial_o6 = (AdcRegs.ADCRESULT5) >> 4;
           ...
           *  Gain: '<S1>/Gain8'
           */
          tmp = floor((1.0 / Z_OL3_P.ADC_mapping * Z_OL3_B.analogdial_o3 * 2.0 *
                       10.0 - 10.0) * Z_OL3_P.Gain14_Gain * Z_OL3_P.Gain4_Gain);
          if (rtIsNaN(tmp) || rtIsInf(tmp)) {
            tmp = 0.0;
          } else {
            tmp = fmod(tmp, 65536.0);
           ...
           *  Gain: '<S1>/Gain7'
           */
          tmp = floor(((1.0 / Z_OL3_P.ADC_mapping * Z_OL3_B.analogdial_o5 * 2.0 *
                        10.0 - 10.0) * 2.0 - 0.4) * Z_OL3_P.Gain7_Gain *
                      Z_OL3_P.Gain5_Gain);
          if (rtIsNaN(tmp) || rtIsInf(tmp)) {
            tmp = 0.0;
          } else {
          ...
          /* S-Function (c280xpwm): '<S1>/pass to ePWM1' incorporates:
           ...
           *  Gain: '<S1>/Gain13'
           */
          tmp = floor(((1.0 / Z_OL3_P.ADC_mapping * Z_OL3_B.analogdial_o6 * 2.0 *
                        10.0 - 10.0) - 0.29) * Z_OL3_P.Gain_Gain *
                      Z_OL3_P.Gain13_Gain);
          if (rtIsNaN(tmp) || rtIsInf(tmp)) {
            tmp = 0.0;
          } else {
          ...
          /* S-Function (c280xpwm): '<S1>/pass to ePWM2' incorporates:
