...
#include "rtwtypes.h"
#include "final__ZCL3_private.h"
#include <math.h>
#include "rt_nonfinite.h"

/* Block signals (default storage) */
B_final__ZCL3_T final__ZCL3_B;

/* Block states (default storage) */
DW_final__ZCL3_T final__ZCL3_DW;

/* Real-time model */
static RT_MODEL_final__ZCL3_T final__ZCL3_M_;
RT_MODEL_final__ZCL3_T *const final__ZCL3_M = &final__ZCL3_M_;
 ...
 *    '<S7>/VL2duty'
 */
void final__ZCL3_VL2duty(real_T rtu_VLref, real_T rtu_Vin_fb, real_T rtu_Vout_fb,
  B_VL2duty_final__ZCL3_T *localB)
{
  real_T x_idx_1;
...
void final__ZCL3_initialize(void)
{
  /* Registration code */
  ...
  rtmSetErrorStatus(final__ZCL3_M, (NULL));

  /* block I/O */
  {
    final__ZCL3_B.analogdial_o1 = 0.0;
    final__ZCL3_B.analogdial_o2 = 0.0;
    final__ZCL3_B.analogdial_o3 = 0.0;
    final__ZCL3_B.analogdial_o4 = 0.0;
    final__ZCL3_B.analogdial_o5 = 0.0;
    final__ZCL3_B.analogdial_o6 = 0.0;
    final__ZCL3_B.sf_VL2duty_n.D = 0.0;
    final__ZCL3_B.sf_VL2duty_h.D = 0.0;
    final__ZCL3_B.sf_VL2duty.D = 0.0;
  }

  /* states (dwork) */
  final__ZCL3_DW.discreteintegrator_states = 0.0;
  final__ZCL3_DW.discreteintegrator_states_g = 0.0;
  final__ZCL3_DW.discreteintegrator_states_a = 0.0;
  final__ZCL3_DW.discreteintegrator_states_i = 0.0;
  final__ZCL3_DW.Memory_PreviousInput = 0.0;
  final__ZCL3_DW.Memory2_PreviousInput = 0.0;
  final__ZCL3_DW.Memory_PreviousInput_b = 0.0;
  final__ZCL3_DW.Memory_PreviousInput_o = 0.0;
  final__ZCL3_DW.Memory_PreviousInput_i = 0.0;
  ...
  /*** Initialize ePWM6 modules ***/
  {
    ...
    /*-- Setup Event-Trigger (ET) Submodule --*/
    /* // Event-Trigger Selection and Event-Trigger Pre-Scale Register
       EPwm6Regs.ETSEL.bit.SOCAEN     = 1;          // Start of conversion A Enable
     ...
     */
    EPwm6Regs.ETSEL.all = (EPwm6Regs.ETSEL.all & ~0xFF0F) | 0x1A01;
  ...
  final__ZCL3_DW.Memory_PreviousInput = final__ZCL3_P.Memory_InitialCondition;

  /* InitializeConditions for Memory: '<S3>/Memory2' */
  final__ZCL3_DW.Memory2_PreviousInput = final__ZCL3_P.Memory2_InitialCondition;

  /* InitializeConditions for Memory: '<S3>/Memory' */
  final__ZCL3_DW.Memory_PreviousInput_b =
    final__ZCL3_P.Memory_InitialCondition_n;

  /* InitializeConditions for DiscreteTransferFcn: '<S3>/discrete integrator' */
  final__ZCL3_DW.discreteintegrator_states =
    final__ZCL3_P.discreteintegrator_InitialState;

  /* InitializeConditions for DiscreteTransferFcn: '<S6>/discrete integrator' */
  final__ZCL3_DW.discreteintegrator_states_g =
    final__ZCL3_P.discreteintegrator_InitialSta_j;

  /* InitializeConditions for Memory: '<S5>/Memory' */
  final__ZCL3_DW.Memory_PreviousInput_o =
    final__ZCL3_P.Memory_InitialCondition_l;

  /* InitializeConditions for DiscreteTransferFcn: '<S5>/discrete integrator' */
  final__ZCL3_DW.discreteintegrator_states_a =
    final__ZCL3_P.discreteintegrator_InitialSta_o;

  /* InitializeConditions for Memory: '<S7>/Memory' */
  final__ZCL3_DW.Memory_PreviousInput_i =
    final__ZCL3_P.Memory_InitialCondition_j;

  /* InitializeConditions for DiscreteTransferFcn: '<S7>/discrete integrator' */
  final__ZCL3_DW.discreteintegrator_states_i =
    final__ZCL3_P.discreteintegrator_InitialSta_n;

  /* End of SystemInitialize for S-Function (HardwareInterrupt_sfun): '<S15>/Hardware Interrupt' */
}

/* Model terminate function */
void final__ZCL3_terminate(void)
{
  /* (no terminate code required) */
}

void final__ZCL3_configure_interrupts(void)
{
    ...
    if (1 == runModel) {
      {
        ...
        /* Output and update for function-call system: '<Root>/ADC-PWM Subsystem' */
        {
          ...
          real_T discreteintegrator_tmp_h;
          real_T discreteintegrator_tmp_i;
          real_T discreteintegrator_tmp_l;
          real_T rtb_Gain15_j;
          ...
          {
            final__ZCL3_B.analogdial_o1 = (AdcRegs.ADCRESULT0) >> 4;
            final__ZCL3_B.analogdial_o2 = (AdcRegs.ADCRESULT1) >> 4;
            final__ZCL3_B.analogdial_o3 = (AdcRegs.ADCRESULT2) >> 4;
            final__ZCL3_B.analogdial_o4 = (AdcRegs.ADCRESULT3) >> 4;
            final__ZCL3_B.analogdial_o5 = (AdcRegs.ADCRESULT4) >> 4;
            final__ZCL3_B.analogdial_o6 = (AdcRegs.ADCRESULT5) >> 4;
           ...
           *  Gain: '<S1>/Gain9'
           */
          final__ZCL3_B.Vfb = 1.0 / final__ZCL3_P.ADC_mapping *
            final__ZCL3_B.analogdial_o4 * final__ZCL3_P.VfbMax;

          /* Fcn: '<S1>/Fcn3' incorporates:
           *  Gain: '<S1>/Gain3'
           */
          final__ZCL3_B.Vout_ref = 1.0 / final__ZCL3_P.ADC_mapping *
            final__ZCL3_B.analogdial_o1 * 30.0 + 30.0;

          /* DataTypeConversion: '<S1>/Cast To Single8' incorporates:
           *  Gain: '<S1>/Gain18'
           */
          tmp = floor(final__ZCL3_P.Gain18_Gain * final__ZCL3_B.Vfb);
           ...
           *  Gain: '<S1>/Gain19'
           */
          rtb_discreteintegrator_tmp = floor(final__ZCL3_P.Gain19_Gain *
            final__ZCL3_B.Vout_ref);
           ...
           *  Gain: '<S7>/Gain3'
           */
          rtb_discreteintegrator_tmp = final__ZCL3_P.VLlim *
            final__ZCL3_P.VinNom;
           ...
           *  Sum: '<S3>/Sum8'
           */
          discreteintegrator_tmp = (((final__ZCL3_B.Vout_ref - final__ZCL3_B.Vfb)
            - final__ZCL3_DW.Memory_PreviousInput_b) * final__ZCL3_P.ki_v -
            final__ZCL3_P.zden_Integrator[1L] *
            final__ZCL3_DW.discreteintegrator_states) /
            final__ZCL3_P.zden_Integrator[0];

          /* Sum: '<S3>/Sum9' incorporates:
           *  DiscreteTransferFcn: '<S3>/discrete integrator'
           *  Gain: '<S3>/Gain15'
           */
          final__ZCL3_B.Gain13 = (final__ZCL3_P.znum_Integrator[0] *
            discreteintegrator_tmp + final__ZCL3_P.znum_Integrator[1L] *
            final__ZCL3_DW.discreteintegrator_states) - final__ZCL3_P.kp_v *
            final__ZCL3_B.Vfb;
          ...
          if (final__ZCL3_B.Vout_ref < final__ZCL3_P.VinNom) {
            /* '<S4>:1:3' */
            /* '<S4>:1:4' */
            final__ZCL3_B.Vout_ref = final__ZCL3_P.VinNom;
          }

          /* '<S4>:1:6' */
          final__ZCL3_B.Vout_ref = (final__ZCL3_P.VinNom - final__ZCL3_P.RserL *
            final__ZCL3_DW.Memory2_PreviousInput) / final__ZCL3_B.Vout_ref;

          /* '<S4>:1:7' */
          final__ZCL3_B.IL = final__ZCL3_B.Gain13 / final__ZCL3_B.Vout_ref;

          /* Saturate: '<S3>/Saturation2' */
          if (final__ZCL3_B.IL > final__ZCL3_P.ILmax) {
            final__ZCL3_B.IL = final__ZCL3_P.ILmax;
          } else if (final__ZCL3_B.IL < -final__ZCL3_P.ILmax) {
            final__ZCL3_B.IL = -final__ZCL3_P.ILmax;
          }
          ...
          /* Gain: '<S3>/Gain6' */
          final__ZCL3_B.Gain20 = final__ZCL3_P.Gain6_Gain * final__ZCL3_B.IL;
           ...
           *  Gain: '<S1>/Gain7'
           */
          final__ZCL3_B.Gain17 = (1.0 / final__ZCL3_P.ADC_mapping *
            final__ZCL3_B.analogdial_o5 * 2.0 * 10.0 - 10.0) *
            final__ZCL3_P.Gain7_Gain * 1.0381 + 0.1751;
           ...
           *  Sum: '<S6>/Sum3'
           */
          discreteintegrator_tmp_h = (((final__ZCL3_B.Gain20 -
            final__ZCL3_B.Gain17) - final__ZCL3_DW.Memory_PreviousInput) *
            final__ZCL3_P.ki_i - final__ZCL3_P.zden_Integrator[1L] *
            final__ZCL3_DW.discreteintegrator_states_g) /
            final__ZCL3_P.zden_Integrator[0];
           ...
           *  Gain: '<S6>/Gain1'
           */
          final__ZCL3_B.Gain = (final__ZCL3_P.znum_Integrator[0] *
                                discreteintegrator_tmp_h +
                                final__ZCL3_P.znum_Integrator[1L] *
                                final__ZCL3_DW.discreteintegrator_states_g) -
            final__ZCL3_P.kp_i * final__ZCL3_B.Gain17;

          /* Switch: '<S10>/Switch2' incorporates:
           *  Gain: '<S6>/Gain3'
           *  RelationalOperator: '<S10>/LowerRelop1'
           */
          if (final__ZCL3_B.Gain > rtb_discreteintegrator_tmp) {
            final__ZCL3_B.Switch2 = rtb_discreteintegrator_tmp;
          } else {
            /* Sum: '<S6>/Sum4' incorporates:
             *  Constant: '<S1>/Constant'
             */
            final__ZCL3_B.Gain5 = final__ZCL3_P.VinNom - final__ZCL3_B.Vfb;

            /* Switch: '<S10>/Switch' incorporates:
             *  RelationalOperator: '<S10>/UpperRelop'
             */
            if (final__ZCL3_B.Gain < final__ZCL3_B.Gain5) {
              final__ZCL3_B.Switch2 = final__ZCL3_B.Gain5;
            } else {
              final__ZCL3_B.Switch2 = final__ZCL3_B.Gain;
            }
           ...
           *  Constant: '<S1>/Constant'
           */
          final__ZCL3_VL2duty(final__ZCL3_B.Switch2, final__ZCL3_P.VinNom,
                              final__ZCL3_B.Vfb, &final__ZCL3_B.sf_VL2duty_h);

          /* DataTypeConversion: '<S1>/Cast To Single2' incorporates:
           *  Gain: '<S1>/Gain1'
           */
          tmp = floor(final__ZCL3_P.TBPRD * final__ZCL3_B.sf_VL2duty_h.D);
          if (rtIsNaN(tmp) || rtIsInf(tmp)) {
            tmp = 0.0;
          } else {
            tmp = fmod(tmp, 65536.0);
           ...
           *  Gain: '<S1>/Gain8'
           */
          final__ZCL3_B.Gain13_l = (1.0 / final__ZCL3_P.ADC_mapping *
            final__ZCL3_B.analogdial_o3 * 2.0 * 10.0 - 10.0) *
            final__ZCL3_P.Gain2_Gain * 0.71 + 0.1464;
           ...
           *  Sum: '<S5>/Sum3'
           */
          discreteintegrator_tmp_i = (((final__ZCL3_B.Gain20 -
            final__ZCL3_B.Gain13_l) - final__ZCL3_DW.Memory_PreviousInput_o) *
            final__ZCL3_P.ki_i - final__ZCL3_P.zden_Integrator[1L] *
            final__ZCL3_DW.discreteintegrator_states_a) /
            final__ZCL3_P.zden_Integrator[0];
           ...
           *  Gain: '<S5>/Gain1'
           */
          final__ZCL3_B.Gain_m = (final__ZCL3_P.znum_Integrator[0] *
            discreteintegrator_tmp_i + final__ZCL3_P.znum_Integrator[1L] *
            final__ZCL3_DW.discreteintegrator_states_a) - final__ZCL3_P.kp_i *
            final__ZCL3_B.Gain13_l;

          /* Switch: '<S8>/Switch2' incorporates:
           *  RelationalOperator: '<S8>/LowerRelop1'
           */
          if (final__ZCL3_B.Gain_m > rtb_discreteintegrator_tmp) {
            final__ZCL3_B.Switch2_c = rtb_discreteintegrator_tmp;
          } else {
             ...
             */
            if (final__ZCL3_B.Gain_m < final__ZCL3_B.Gain5) {
              final__ZCL3_B.Switch2_c = final__ZCL3_B.Gain5;
            } else {
              final__ZCL3_B.Switch2_c = final__ZCL3_B.Gain_m;
            }
           ...
           *  Constant: '<S1>/Constant'
           */
          final__ZCL3_VL2duty(final__ZCL3_B.Switch2_c, final__ZCL3_P.VinNom,
                              final__ZCL3_B.Vfb, &final__ZCL3_B.sf_VL2duty);

          /* DataTypeConversion: '<S1>/Cast To Single3' incorporates:
           *  Gain: '<S1>/Gain4'
           */
          tmp = floor(final__ZCL3_P.TBPRD * final__ZCL3_B.sf_VL2duty.D);
          if (rtIsNaN(tmp) || rtIsInf(tmp)) {
            tmp = 0.0;
          } else {
            tmp = fmod(tmp, 65536.0);
          ...
          /* Gain: '<S7>/Gain3' */
          final__ZCL3_B.Gain5 = rtb_discreteintegrator_tmp;

          /* Fcn: '<S1>/Fcn4' incorporates:
           *  Fcn: '<S1>/Fcn8'
           *  Gain: '<S1>/Gain11'
           *  Gain: '<S1>/Gain6'
           */
          rtb_Gain15_j = (1.0 / final__ZCL3_P.ADC_mapping *
                          final__ZCL3_B.analogdial_o6 * 2.0 * 10.0 - 10.0) *
            final__ZCL3_P.Gain6_Gain_j * 0.9402 + 0.3077;
           ...
           *  Sum: '<S7>/Sum3'
           */
          discreteintegrator_tmp_l = (((final__ZCL3_B.Gain20 - rtb_Gain15_j) -
            final__ZCL3_DW.Memory_PreviousInput_i) * final__ZCL3_P.ki_i -
            final__ZCL3_P.zden_Integrator[1L] *
            final__ZCL3_DW.discreteintegrator_states_i) /
            final__ZCL3_P.zden_Integrator[0];
           ...
           *  Gain: '<S7>/Gain1'
           */
          final__ZCL3_B.discreteintegrator = (final__ZCL3_P.znum_Integrator[0] *
            discreteintegrator_tmp_l + final__ZCL3_P.znum_Integrator[1L] *
            final__ZCL3_DW.discreteintegrator_states_i) - final__ZCL3_P.kp_i *
            rtb_Gain15_j;

          /* Switch: '<S12>/Switch2' incorporates:
           *  RelationalOperator: '<S12>/LowerRelop1'
           */
          if (!(final__ZCL3_B.discreteintegrator > rtb_discreteintegrator_tmp))
          {
             ...
             */
            if (!(final__ZCL3_B.discreteintegrator < final__ZCL3_B.Gain5)) {
              final__ZCL3_B.Gain5 = final__ZCL3_B.discreteintegrator;
            }
           ...
           *  Constant: '<S1>/Constant'
           */
          final__ZCL3_VL2duty(final__ZCL3_B.Gain5, final__ZCL3_P.VinNom,
                              final__ZCL3_B.Vfb, &final__ZCL3_B.sf_VL2duty_n);

          /* DataTypeConversion: '<S1>/Cast To Single4' incorporates:
           *  Gain: '<S1>/Gain5'
           */
          tmp = floor(final__ZCL3_P.TBPRD * final__ZCL3_B.sf_VL2duty_n.D);
          if (rtIsNaN(tmp) || rtIsInf(tmp)) {
            tmp = 0.0;
          } else {
            tmp = fmod(tmp, 65536.0);
           ...
           *  Gain: '<S1>/Gain13'
           */
          tmp = floor(final__ZCL3_P.Gain13_Gain * final__ZCL3_B.Gain13_l);
          if (rtIsNaN(tmp) || rtIsInf(tmp)) {
            tmp = 0.0;
          } else {
            tmp = fmod(tmp, 65536.0);
           ...
           *  Gain: '<S1>/Gain17'
           */
          rtb_discreteintegrator_tmp = floor(final__ZCL3_P.Gain17_Gain *
            final__ZCL3_B.Gain17);
          if (rtIsNaN(rtb_discreteintegrator_tmp) || rtIsInf
              (rtb_discreteintegrator_tmp)) {
            rtb_discreteintegrator_tmp = 0.0;
          } else {
           ...
           *  Gain: '<S1>/Gain15'
           */
          tmp = floor(final__ZCL3_P.Gain15_Gain * rtb_Gain15_j);
          if (rtIsNaN(tmp) || rtIsInf(tmp)) {
            tmp = 0.0;
          } else {
            tmp = fmod(tmp, 65536.0);
           ...
           *  Gain: '<S1>/Gain20'
           */
          rtb_discreteintegrator_tmp = floor(final__ZCL3_P.Gain20_Gain *
            final__ZCL3_B.Gain20);
          if (rtIsNaN(rtb_discreteintegrator_tmp) || rtIsInf
              (rtb_discreteintegrator_tmp)) {
            rtb_discreteintegrator_tmp = 0.0;
          } else {
           ...
           *  Sum: '<S6>/Sum2'
           */
          final__ZCL3_DW.Memory_PreviousInput = (final__ZCL3_B.Gain -
            final__ZCL3_B.Switch2) * final__ZCL3_P.kaw_i;

          /* Update for Memory: '<S3>/Memory2' */
          final__ZCL3_DW.Memory2_PreviousInput = final__ZCL3_B.IL;
           ...
           *  Sum: '<S3>/Sum13'
           */
          final__ZCL3_DW.Memory_PreviousInput_b = (final__ZCL3_B.Gain13 -
            final__ZCL3_B.IL * final__ZCL3_B.Vout_ref) * final__ZCL3_P.kaw_v;

          /* Update for DiscreteTransferFcn: '<S3>/discrete integrator' */
          final__ZCL3_DW.discreteintegrator_states = discreteintegrator_tmp;

          /* Update for DiscreteTransferFcn: '<S6>/discrete integrator' */
          final__ZCL3_DW.discreteintegrator_states_g = discreteintegrator_tmp_h;

          /* Update for Memory: '<S5>/Memory' incorporates:
           *  Gain: '<S5>/Gain2'
           *  Sum: '<S5>/Sum2'
           */
          final__ZCL3_DW.Memory_PreviousInput_o = (final__ZCL3_B.Gain_m -
            final__ZCL3_B.Switch2_c) * final__ZCL3_P.kaw_i;

          /* Update for DiscreteTransferFcn: '<S5>/discrete integrator' */
          final__ZCL3_DW.discreteintegrator_states_a = discreteintegrator_tmp_i;
           ...
           */
          final__ZCL3_DW.Memory_PreviousInput_i =
            (final__ZCL3_B.discreteintegrator - final__ZCL3_B.Gain5) *
            final__ZCL3_P.kaw_i;

          /* Update for DiscreteTransferFcn: '<S7>/discrete integrator' */
          final__ZCL3_DW.discreteintegrator_states_i = discreteintegrator_tmp_l;
        }
...
void final__ZCL3_unconfigure_interrupts (void)
{
