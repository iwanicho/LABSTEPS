...
#ifndef final__ZCL3_h_
#define final__ZCL3_h_
#ifndef final__ZCL3_COMMON_INCLUDES_
#define final__ZCL3_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "IQmathLib.h"
#endif                                 /* final__ZCL3_COMMON_INCLUDES_ */
...
typedef struct {
  ...
  real_T Gain13_l;                     /* '<S1>/Gain13' */
  real_T Gain_m;                       /* '<S5>/Gain' */
  real_T Switch2_c;                    /* '<S8>/Switch2' */
  B_VL2duty_final__ZCL3_T sf_VL2duty_n;/* '<S7>/VL2duty' */
  B_VL2duty_final__ZCL3_T sf_VL2duty_h;/* '<S6>/VL2duty' */
  B_VL2duty_final__ZCL3_T sf_VL2duty;  /* '<S5>/VL2duty' */
} B_final__ZCL3_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T discreteintegrator_states;    /* '<S3>/discrete integrator' */
  real_T discreteintegrator_states_g;  /* '<S6>/discrete integrator' */
  real_T discreteintegrator_states_a;  /* '<S5>/discrete integrator' */
  real_T discreteintegrator_states_i;  /* '<S7>/discrete integrator' */
  real_T Memory_PreviousInput;         /* '<S6>/Memory' */
  real_T Memory2_PreviousInput;        /* '<S3>/Memory2' */
  real_T Memory_PreviousInput_b;       /* '<S3>/Memory' */
  real_T Memory_PreviousInput_o;       /* '<S5>/Memory' */
  real_T Memory_PreviousInput_i;       /* '<S7>/Memory' */
} DW_final__ZCL3_T;

/* Parameters (default storage) */
struct P_final__ZCL3_T_ {
  ...
  real_T Gain6_Gain_j;                 /* Expression: -1
                                        ...
                                        */
  real_T discreteintegrator_InitialSta_n;/* Expression: 0
...
struct tag_RTM_final__ZCL3_T {
  const char_T * volatile errorStatus;
};

/* Block parameters (default storage) */
extern P_final__ZCL3_T final__ZCL3_P;

/* Block signals (default storage) */
extern B_final__ZCL3_T final__ZCL3_B;

/* Block states (default storage) */
extern DW_final__ZCL3_T final__ZCL3_DW;

/* Model entry point functions */
extern void final__ZCL3_initialize(void);
extern void final__ZCL3_terminate(void);

/* Real-time Model object */
extern RT_MODEL_final__ZCL3_T *const final__ZCL3_M;
 ...
 *
 * '<Root>' : 'final__ZCL3'
 * '<S1>'   : 'final__ZCL3/ADC-PWM Subsystem'
 * '<S2>'   : 'final__ZCL3/HWI_SEQ1INT'
 * '<S3>'   : 'final__ZCL3/ADC-PWM Subsystem/control'
 * '<S4>'   : 'final__ZCL3/ADC-PWM Subsystem/control/Iout2IL2'
 * '<S5>'   : 'final__ZCL3/ADC-PWM Subsystem/control/innerLoop_currentControl7'
 * '<S6>'   : 'final__ZCL3/ADC-PWM Subsystem/control/innerLoop_currentControl8'
 * '<S7>'   : 'final__ZCL3/ADC-PWM Subsystem/control/innerLoop_currentControl9'
 * '<S8>'   : 'final__ZCL3/ADC-PWM Subsystem/control/innerLoop_currentControl7/Saturation Dynamic'
 * '<S9>'   : 'final__ZCL3/ADC-PWM Subsystem/control/innerLoop_currentControl7/VL2duty'
 * '<S10>'  : 'final__ZCL3/ADC-PWM Subsystem/control/innerLoop_currentControl8/Saturation Dynamic'
 * '<S11>'  : 'final__ZCL3/ADC-PWM Subsystem/control/innerLoop_currentControl8/VL2duty'
 * '<S12>'  : 'final__ZCL3/ADC-PWM Subsystem/control/innerLoop_currentControl9/Saturation Dynamic'
 * '<S13>'  : 'final__ZCL3/ADC-PWM Subsystem/control/innerLoop_currentControl9/VL2duty'
 * '<S14>'  : 'final__ZCL3/HWI_SEQ1INT/ECSoC'
 * '<S15>'  : 'final__ZCL3/HWI_SEQ1INT/ECSoC/ECSimCodegen'
 */
#endif                                 /* final__ZCL3_h_ */
